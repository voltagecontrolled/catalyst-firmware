...
- `VoltSeq::Data::current_tag = 4u` (bumped in alpha7; added `play_stop_reset`, `master_reset_steps`, `reset_leader_ch`, `_reserved` fields; removed `default_direction`, `default_length`, `default_range`).
