...
| v1.5.0 | Catalyst VoltSeq: 8-channel voltage recorder/sequencer as second firmware personality; two build variants (CatSeq+CatCon, CatSeq+VoltSeq) | RC2 |
| v1.5.1 | VoltSeq UX pass: range/transpose/random rework, peek-before-edit for length and clock div, clear defaults 0V/gates-off | In progress |
